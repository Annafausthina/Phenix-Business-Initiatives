  ...
  <div className="relative overflow-hidden">
    ...
    <section className="relative pt-48 pb-24 px-4 overflow-hidden bg-[#149184]/5">
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-[#149184]/10 rounded-full blur-[120px] opacity-40" />
      </div>

      <div className="relative z-10 max-w-7xl mx-auto text-center">
        <ScrollReveal variant={2}>
          <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#149184]/10 border border-[#149184]/30 text-[#149184] text-xs font-bold uppercase tracking-[0.2em] mb-8 backdrop-blur-md">
            <Award className="h-3.5 w-3.5" />
            Excellence & Experience
          </span>
          <h1 className="text-shimmer text-5xl md:text-7xl font-black mb-8 leading-tight">
            About our company & <br /><span className="text-[#149184]">experienced staff</span>
          </h1>
        </ScrollReveal>
      </div>
    </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-5 relative">
            <ScrollReveal variant={3} direction="left">
              <div className="relative rounded-[3rem] overflow-hidden border border-white/20 shadow-2xl group">
                <img
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#149184]/80 via-transparent to-transparent" />
                <div className="absolute bottom-8 left-8 right-8 p-8 rounded-3xl bg-white/10 backdrop-blur-xl border border-white/20 text-white">
          ...
          <div className="lg:col-span-7 space-y-10">
            <ScrollReveal variant={3} direction="right">
              <div className="space-y-6">
                <p className="text-lg md:text-xl text-foreground font-medium leading-relaxed">
                  <span className="text-[#149184] font-black italic">Phoenix Business Initiatives (PBI)</span> is a young and vibrant company that aims to provide high quality services. At PBI, we strive to achieve the highest level of <span className="font-bold border-b-2 border-primary/30">"Customer Satisfaction"</span> possible.
                </p>
            ...
            <ScrollReveal delay={0.2} variant={3} direction="right">
              <div className="p-8 rounded-[2.5rem] bg-card border border-border shadow-xl hover:translate-y-[-5px] transition-transform">
                <Rocket className="h-8 w-8 text-[#149184] mb-6" />
                <p className="text-muted-foreground leading-relaxed">
            ...
            <ScrollReveal delay={0.3} variant={3} direction="right">
              <div className="p-8 rounded-[2.5rem] bg-[#149184]/5 border border-[#149184]/20 shadow-xl">
                <Users className="h-8 w-8 text-[#149184] mb-6" />
                <p className="text-muted-foreground leading-relaxed">
    ...
    <Section className="bg-card/50 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto space-y-12">
        <ScrollReveal variant={2}>
          <div className="p-10 rounded-[3rem] bg-white/5 border border-white/10 backdrop-blur-sm">
      ...
      <ScrollReveal>
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-black mb-6">
            Client <span className="text-[#149184]">Benefits</span>
          </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto">
        {benefits.map((b, i) => (
          <ScrollReveal key={i} delay={i * 0.1} variant={3} direction="up">
            <div className="group h-full flex flex-col p-8 rounded-[2.5rem] bg-white/5 border border-white/10 hover:border-[#149184]/40 transition-all duration-500 hover:translate-y-[-10px] shadow-2xl relative overflow-hidden">
              <div className="mb-6 h-14 w-14 rounded-2xl bg-[#149184]/10 flex items-center justify-center text-[#149184] group-hover:scale-110 transition-transform">
              ...
              <ul className="space-y-4 flex-grow">
                {b.items.map((item, j) => (
                  <li key={j} className="flex items-start gap-3 text-sm font-semibold text-muted-foreground group-hover:text-foreground transition-colors">
                    <CheckCircle className="h-4 w-4 mt-0.5 shrink-0 text-[#149184]" />
                    {item}
                  </li>
                ))}
              </ul>
    ...
    {/* Testimonials */}
    <Section className="bg-[#149184]/5">
      <ScrollReveal>
        <h2 className="mb-16 text-center text-4xl md:text-5xl font-black text-[#149184]">
